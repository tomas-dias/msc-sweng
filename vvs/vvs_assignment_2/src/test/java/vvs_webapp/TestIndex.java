...
public class TestIndex {
	...
	public void insertAndRemoveClientTest() throws IOException {
		...
		// HtmlPage reportPage = submit.click();        // NOT WORKING!
		// String textReportPage = reportPage.asText(); //   \-->  returns the same page
		
		// alternative:  (ref: https://stackoverflow.com/questions/21628614/)
		HtmlPage reportPage;
		String formData = String.format("vat=%s&designation=%s&phone=%s", NPC, DESIGNATION, PHONE);
